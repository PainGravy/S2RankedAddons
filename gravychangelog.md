...
## Added root/runtime files

- `Bridge/app.spec`
- `Bridge/bridge.log`
- `Bridge/match_cache.json`
- `Bridge/settings.json`

## Added Python cache files

- `Bridge/__pycache__/active_matches_page.cpython-313.pyc`
- `Bridge/__pycache__/api_client.cpython-313.pyc`
- `Bridge/__pycache__/bridge_controller.cpython-313.pyc`
- `Bridge/__pycache__/config.cpython-313.pyc`
- `Bridge/__pycache__/fastest_times_page.cpython-313.pyc`
- `Bridge/__pycache__/leaderboard_page.cpython-313.pyc`
- `Bridge/__pycache__/login_page.cpython-313.pyc`
- `Bridge/__pycache__/main_window.cpython-313.pyc`
- `Bridge/__pycache__/match_cache.cpython-313.pyc`
- `Bridge/__pycache__/match_detail_page.cpython-313.pyc`
- `Bridge/__pycache__/match_history_page.cpython-313.pyc`
- `Bridge/__pycache__/overlay_window.cpython-313.pyc`
- `Bridge/__pycache__/profile_page.cpython-313.pyc`
- `Bridge/__pycache__/rank_utils.cpython-313.pyc`
- `Bridge/__pycache__/settings_page.cpython-313.pyc`
- `Bridge/__pycache__/settings_store.cpython-313.pyc`
- `Bridge/__pycache__/steam_auth.cpython-313.pyc`
- `Bridge/__pycache__/udp_relay.cpython-313.pyc`
- `Bridge/__pycache__/update_panel.cpython-313.pyc`
- `Bridge/__pycache__/updater_service.cpython-313.pyc`
- `Bridge/__pycache__/ws_client.cpython-313.pyc`

## Added build files

- `Bridge/build/app/Analysis-00.toc`
- `Bridge/build/app/base_library.zip`
- `Bridge/build/app/COLLECT-00.toc`
- `Bridge/build/app/EXE-00.toc`
- `Bridge/build/app/localpycs/pyimod01_archive.pyc`
- `Bridge/build/app/localpycs/pyimod02_importers.pyc`
- `Bridge/build/app/localpycs/pyimod03_ctypes.pyc`
- `Bridge/build/app/localpycs/pyimod04_pywin32.pyc`
- `Bridge/build/app/localpycs/struct.pyc`
- `Bridge/build/app/PKG-00.toc`
- `Bridge/build/app/PYZ-00.pyz`
- `Bridge/build/app/PYZ-00.toc`
- `Bridge/build/app/warn-app.txt`
- `Bridge/build/app/xref-app.html`
- `Bridge/build/app/app.pkg`

## Added dist files

- `Bridge/dist/app.exe`
- `Bridge/dist/bridge.log`
- `Bridge/dist/match_cache.json`
- `Bridge/dist/S2Ranked.exe`
- `Bridge/dist/settings.json`
- `Bridge/dist/setup.bat`
- `Bridge/dist/version.txt`

## Added packaged runtime tree

- `Bridge/dist/_internal/` directory tree added
- Includes packaged runtime/dependency files for:
  - PySide6
  - Qt plugins
  - Qt translations
  - Python runtime DLLs
